...
void map_terma(pybind11::array_t<float> terma_grid,
    pybind11::array_t<float> fluence_grid, pybind11::array_t<float> d_geo_grid,
    pybind11::array_t<float> d_eff_grid, pybind11::array_t<int> num_voxels,
    int num_energies, pybind11::array_t<float> energies,
    pybind11::array_t<float> energy_weights, pybind11::array_t<float> mu_w,
    float source_sad,
