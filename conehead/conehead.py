...
class Conehead:
    ...
    def plot(self):
        ...
        def plot_30x30_profiles():  # pylint: disable=W0612
            ...
            d5 = d5 / d5[100] * 100
            ax4.plot(x5, d5, 'o', markersize=2, label='5 cm tank')
            ...
            d10 = d10 / d10[100] * 100
            ax4.plot(x10, d10, 'o', markersize=2, label='10 cm tank')
            ...
            d20 = d20 / d20[101] * 100
            ax4.plot(x20, d20, 'o', markersize=2, label='20 cm tank')
            ...
            d30 = d30 / d30[101] * 100
            ax4.plot(x30, d30, 'o', markersize=2, label='30 cm tank')
