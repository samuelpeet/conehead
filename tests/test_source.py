...
class TestSource:
    ...
    def test_gantry_0(self):
        ...
        np.testing.assert_array_almost_equal(source.v_z, np.array([0, 0, 1]), decimal=5)
    ...
    def test_gantry_270(self):
        ...
        np.testing.assert_array_almost_equal(source.v_x, np.array([0, -1, 0]), decimal=5)
        np.testing.assert_array_almost_equal(source.v_y, np.array([1, 0, 0]), decimal=5)
        np.testing.assert_array_almost_equal(source.v_z, np.array([0, 0, 1]), decimal=5)
    ...
    def test_collimator_90(self):
        ...
        np.testing.assert_array_almost_equal(source.v_y, np.array([0, 1, 0]), decimal=5)
        np.testing.assert_array_almost_equal(source.v_z, np.array([-1, 0, 0]), decimal=5)
    ...
    def test_gantry_90_collimator_90(self):
        ...
        np.testing.assert_array_almost_equal(source.v_x, np.array([0, 0, 1]), decimal=5)
        np.testing.assert_array_almost_equal(source.v_y, np.array([-1, 0, 0]), decimal=5)
        np.testing.assert_array_almost_equal(source.v_z, np.array([0, -1, 0]), decimal=5)
